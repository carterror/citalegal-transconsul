...
jazzmin_settings = {
    ...
    "login_logo": "/assets/img/logo_oficial.png",
    ...
    "welcome_sign": "Bienvenido a Cita-Legal",

    # Copyright on the footer
    "copyright": "Cita-Legal UCI",
    ...
    "order_with_respect_to": ["auth", "usuarios", "account", "citas", "blog"],
